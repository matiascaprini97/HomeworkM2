...
// Tu código acá:
var miNombre = document.querySelector("#createdBy")
miNombre.innerHTML += " Matías."
...
function ToDo(description) {
  // Tu código acá:
  if (typeof description !== 'string') { throw new Error("debe ser un string") };
...
function displayToDos() {
  ...
  toDoElements.forEach(element => { toDoContainer.appendChild(element) });
}
